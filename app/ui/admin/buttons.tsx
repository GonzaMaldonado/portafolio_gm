...
import { deleteSkill, deleteProject } from '@/app/lib/actions';

export function CreateItem({ name }: { name: string }) {
  return (
    <Link
...
export function UpdateItem({ id, name }: { id: string, name: string }) {
  return (
    <Link
      href={`/admin/${name}/${id}/edit`}
